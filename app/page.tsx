...
const EXERCISE_LIST: Record<string, string[]> = {
  ...
  하체: [
    ...
    '스미스 머신 스쿼트', '스미스 머신 런지', '스미스 머신 하이 바 스쿼트', '스미스 머신 스플릿 스쿼트',
    '레그 프레스 (머신)', '파워 레그 프레스 (머신)', '레그 익스텐션 (머신)', '라이잉 레그 컬 (머신)', '시티드 레그 컬 (머신)', '이너 쓰아이/아웃타이 머신 (머신)', '힙 어덕션 (머신)', '스탠딩 카프 레이즈 머신 (머신)',
